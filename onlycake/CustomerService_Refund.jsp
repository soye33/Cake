...
.sub li a:hover::after {
    ...
    margin: 70px auto 200px; /* Center horizontally with auto */
...
<body>
   <div class="header-nav-container">
    ...
    <div id="content_1">
        <a href="LoginOK.jsp"><b>환불 및 교환 정책</b></a><br>
	...
	<h3>환불 요청 기한</h3>
	<p>주문제작 상품으로 제작에 들어가면 취소가 불가능합니다. 주문 완료한 날짜로부터 2일 이내에 환불요청을 해야 합니다.</p>
	<p>이 기간이 넘어가면 환불불가합니다.</p>
	<h3>교환/환불/반품이 불가능한 경우</h3>
	<p>고객의 사유로 제품의 전부 또는 일부가 멸실/훼손된 경우. 시간의 경과에 의해 제품의 가치가 현저히 감소한 경우.</p> 
	<p>제품 수령후 케이크를 드신 경우. 고객의 단순변심. </p>
	<h3>교환/환불/반품 요청시</h3>
	<p>제품 불량을 증명할 수 있는 사진이나 동영상을 함께 첨부하여 문의 페이지에 올려주시면 빠르게 도움드리겠습니다.</p>
	<a href="InsertInquiry.jsp" class="request">교환/환불/반품 요청</a>
	</div>
