...
%>
    ...
    if (value === "high") {
        window.location.href = "HighCakeWedding.jsp";
    } else if (value === "low") {
        // 여기에 가격 낮은 순으로 이동할 페이지를 추가
        window.location.href = "LowCakeWedding.jsp"; 
    }
	else if (value === "normal") {
        window.location.href = "CakeWedding.jsp"; 
    }
		...
		<div id="sortMenu" style="display: none;">
         ...
         <%
            ...
            try {
                ...
                String jsql = "SELECT * FROM cake WHERE ctgType = '결혼식케이크' ORDER BY prdPrice DESC;"; 
        ...
        %>
						...
						<a href="detail.jsp?prdNo=<%= prdNo %>">
                            <div class="cake_image">
                                <img src="images/<%=prdImage%>" alt="결혼식 케이크<%= count + 1 %>">
                            </div>
