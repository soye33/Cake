   ...
   <%
    ...
    String memPhone = request.getParameter("phone-prefix") +
        ...
        try {
            ...
            String jsql = "INSERT INTO member (memName, memNickname, memEmail, memBirth, memId, memPwd, memSex, memPhone) VALUES (?,?,?,?,?,?,?,?)"; 
