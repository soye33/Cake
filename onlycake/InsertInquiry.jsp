...
<body>
   <div class="header-nav-container">
    ...
    <div class="content">
        <div class="content2">
            <h2 class="title">문의 작성하기</h2>
			<form method="post" action="InsertInquiry_Ok.jsp" enctype="multipart/form-data">
			...
			<div class="person-information">
				...
				<div class="form-content3">
                    ...
                    <select id="category"name="category">
						...
						<option id="도안문의" value="도안문의">도안문의</option>
						<option id="배송/결제" value="배송/결제">배송/결제</option>
						<option id="교환/환불" value="교환/환불">교환/환불</option>
						<option id="기타문의" value="기타문의">기타문의</option>
                    </select>
				</div>
				<div class="form-content2">
                    <textarea name="text" rows="5" cols="50" required placeholder="문의사항을 입력해주세요"></textarea>
                </div>
				<div class="form-content-pass">
	<label>비밀번호</label>
		<div class="pass">
			<input type="password" name="questionPwd" placeholder="비밀번호를 등록해주세요" id="Qpass" required>
		</div>
	</div>
    ...
    <div class="container2">
        <button type="submit" class="create" style="font-family: 'NanumSquareNeoBold', sans-serif;">문의 등록하기</button>
    </div>
	</form>
		<div id="footer">
            <div class="footer-1">
