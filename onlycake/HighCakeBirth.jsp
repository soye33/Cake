...
%>
    ...
    if (value === "high") {
        window.location.href = "HighCakeBirth.jsp";
    } else if (value === "low") {
        // 여기에 가격 낮은 순으로 이동할 페이지를 추가
        window.location.href = "LowCakeBirth.jsp"; 
    }
	else if (value === "normal") {
        window.location.href = "CakeBirth.jsp"; 
    }
...
.sub li a:hover::after {
    ...
    transform: translateY(-50%) scale(1.1); /* 살짝 커지면서 등장 */
			...
			.history p {
             ...
             #content_3 {
				background-image:url('images/birthBackground.png');
    ...
    <div id="content_3"> 
		...
		<div id="sortMenu" style="display: none;">
			<select onchange="sortItems(this.value)">
				...
				<option value="high" selected>가격 높은 순</option>
         ...
         <%
            ...
            try {
                ...
                String jsql = "SELECT * FROM cake WHERE ctgType = '생일케이크' ORDER BY prdPrice DESC;"; 
        ...
        %>
						...
						<a href="detail.jsp?prdNo=<%= prdNo %>">
                            <div class="cake_image">
                                <img src="images/<%=prdImage%>" alt="생일 케이크<%= count + 1 %>">
                            </div>
