    ...
    <hr class="vertical-line">
		...
		<div class="main">
			...
			<div class="submit-btngroup">
				<a href="UpdateMember.jsp" class="submit-btn">정보수정</a>
				<a href="DeleteMember.jsp" class="submit-btn1">회원탈퇴</a>
			</div>
		</div>
	</div>
</div>
