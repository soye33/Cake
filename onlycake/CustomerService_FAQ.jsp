...
if (keyword != null) {
    try {
        keyword = URLDecoder.decode(keyword, "UTF-8"); // URL 디코딩
    ...
    try {
        ...
        // 기본 SQL 쿼리 작성
        // 기본 SQL 쿼리 작성
String sql = "SELECT questionCategory, questionTitle, memNickname, questionAt FROM question WHERE 1=1";
...
<body>
  ...
  <div class="faq-item" onclick="toggleFAQ(this)">
    <div class="faq-question"> Q1. 도안케이크 가격은 무슨 기준인가요?<span class="faq-icon">+</span></div>
    <div class="faq-answer">도안케이크는 고객님께서 보내주신 이미지를 바탕으로 1:1 맞춤 제작되는 제품입니다.<br>
      케이크의 크기, 색상 구성, 장식 요소, 구현 난이도 등에 따라 가격이 달라지며,<br>
      주문 접수 후 담당자가 디자인을 확인한 뒤 개별적으로 가격을 안내드립니다.<br>
      최종 가격과 결제 방법은 상담을 통해 안내되오니, 도안을 업로드하신 후 기다려 주세요^^
    </div>
  </div>

  <div class="faq-item" onclick="toggleFAQ(this)">
    <div class="faq-question"> Q2. 도안케이크와 디자인케이크의 차이는 무엇인가요?<span class="faq-icon">+</span></div>
    <div class="faq-answer">도안케이크는 고객이 원하는 도안을 기반으로 제작되며,<br>
      디자인케이크는 미리 준비된 고정된 스타일 중에서 선택하는 방식입니다.
    </div>
  </div>

  <div class="faq-item" onclick="toggleFAQ(this)">
    <div class="faq-question"> Q3. 주문사항을 수정하고 싶으면 어떻게 하나요?<span class="faq-icon">+</span></div>
    <div class="faq-answer">제작 전 단계라면 고객센터로 연락 주시면 수정 가능합니다.<br>
      제작이 시작된 이후에는 수정이 어려울 수 있습니다.
    </div>
  </div>

  <div class="faq-item" onclick="toggleFAQ(this)">
    <div class="faq-question"> Q4. 당일 배송 가능한가요?<span class="faq-icon">+</span></div>
    <div class="faq-answer">
    케이크를 제작하는 기간이 있으므로,<br>
    배송은 지정하신 날짜로부터 약 1~2일 뒤에 택배 수령 가능합니다.<br>
    긴급 배송이 필요하신 경우에는 고객센터로 문의해 주세요.
  </div>
  </div>
</div>
...
<%
        ...
        e.printStackTrace();  // <- 여기에 catch 블록이 빠져 있었음
    } finally {
